...
E2 <- function(x0,x1,x2) 3*x0+-0.2*x2+0.1*x1; #no constant
E3 <- function(x0,x2,x3) 0.4*x0+7*x3+-0.3*x2+19.3; #missing 1 variable
E4 <- function(x0,x1,x3) 0.4*x3+20.3; #missing 2 variables
