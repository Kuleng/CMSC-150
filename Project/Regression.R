...
PolynomialRegression<-function(csvfile, degree, realX){
 ...
 print(mainData)
  ...
  #print(mainData$polynomialFunction(realX))
}

PolynomialRegression('~/Desktop/CMSC150/Project/test2.csv',3,1)
